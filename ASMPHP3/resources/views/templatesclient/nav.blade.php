            ...
            <div class="courses-actives">
                ...
                @foreach($khoa_hoc as $khoa)
                 ...
                 <div class="properties__img overlay1">
                  <a href="#"><img src="{{ $khoa->image?''.Storage::url($khoa->image):''}}" style="width: 100px; height: 200px" /></a>
                 </div>
                 <div class="properties__caption">
                   <p>{{$khoa->name}}</p>
                 <h3><a href="#">{{$khoa->describe}}</a></h3>
                 <p>{{$khoa->process}}</p>
                 ...
                 <a href="{{route('route_bill',['id'=>$khoa->id])}}" class="border-btn border-btn2"> Mua khóa học</a>
    ...
    <section class="about-area2 fix pb-padding">
        <div class="support-wrapper align-items-center">
            ...
            <div class="left-content2">
                ...
                <div class="section-tittle section-tittle2 mb-20">
                    <div class="front-text">
                        <h2 class="">Take the next step toward your personal and professional goals with us.</h2>
